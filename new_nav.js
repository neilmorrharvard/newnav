    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                .bottom-row-inner { padding-top: 20px; }
            ...
            .text-link { color: var(--text-inactive); text-decoration: none; font-size: 13px; font-weight: 400; border-bottom: 2px solid transparent; padding-bottom: 2px; }
        ...
        <div class="nav-content-wrapper">
            ...
            <div class="top-row hide-scrollbar" id="main-top-row">
                <div id="comm-container" data-category="communities">
                    📍 <span id="community-label">Communities</span>
                ...
                <button class="category-pill" data-category="agriculture">🌾 Agriculture</button>
                <button class="category-pill" data-category="obituaries">❤️ Obituaries</button>
                <button class="category-pill" data-category="politics">🏛️ Politics</button>
                <button class="category-pill" data-category="weather">☀️ Weather</button>
                <button class="category-pill" data-category="crime">🔎 Crime & Safety</button>
                <button class="category-pill" id="mega-menu-trigger">☰ More</button>
            </div>
