    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                #village-nav-container:not(:has(.bottom-row.active)) #comm-container.active { padding-bottom: 20px; }
                ...
                .bottom-row-inner { padding-top: 10px !important; padding-bottom: 10px !important; padding-left: 12px; }
