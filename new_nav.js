document.addEventListener('DOMContentLoaded', function() {
    ...
    const iconSports = `<svg class="category-icon" viewBox="0 -960 960 960" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M480-480ZM362-202 202-362q-3 38-1.5 79t7.5 73q23 7 69.5 9t84.5-1Zm96-16q59-13 106-37t82-59q34-34 58-80.5T742-500L500-742q-57 14-103 38.5T316-644q-35 35-59.5 81.5T218-458l240 240Zm-62-122-56-56 224-224 56 56-224 224Zm362-256q4-39 2.5-81t-8.5-73q-23-8-69.5-10t-84.5 2l160 162ZM310-120q-57 0-104-8.5T148-148q-11-12-19.5-60T120-314q0-119 36-220.5T258-702q66-66 169-102t223-36q58 0 104.5 8.5T812-812q11 12 19.5 60t8.5 108q0 117-36 218.5T702-258q-65 65-168 101.5T310-120Z"/></svg>`;
    const iconAgriculture = `<svg class="category-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M19.5 12c.83 0 1.5-.67 1.5-1.5 0-.84-1.51-3.17-1.5-4.5 0-.83-.67-1.5-1.5-1.5S18 5.17 18 6c0 1.33-1.5 3.66-1.5 4.5 0 .83.67 1.5 1.5 1.5zm-5.04-1.26c.18-.37.38-.72.62-1.06.24-.33.5-.63.78-.9.02-.02.04-.04.06-.06-.41-.28-.87-.49-1.35-.63-.19.07-.38.15-.57.26-.19.1-.37.21-.54.33-.17.12-.33.26-.48.4-.15.15-.28.31-.4.48-.12.17-.23.35-.33.54-.11.19-.19.38-.26.57.14.48.35.94.63 1.35.02-.02.04-.04.06-.06.27-.28.57-.54.9-.78.34-.24.69-.44 1.06-.62zM12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8z"/></svg>`;
    const iconObituaries = `<svg class="category-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M12 21.35l-1.45-1.32C5.4 15.36 2 12.28 2 8.5 2 5.42 4.42 3 7.5 3c1.74 0 3.41.81 4.5 2.09C13.09 3.81 14.76 3 16.5 3 19.58 3 22 5.42 22 8.5c0 3.78-3.4 6.86-8.55 11.54L12 21.35z"/></svg>`;
    const iconPolitics = `<svg class="category-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2L2 7v10c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V7l-10-5zm-1 16.5v-5H8l4-7v5h3l-4 7z"/></svg>`;
    ...
    const iconCrime = `<svg class="category-icon" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/></svg>`;
    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                .category-pill::after, #comm-container::after { content: ""; position: absolute; bottom: -2px; left: 12px; width: var(--underline-width, auto); height: 2px; background-color: var(--primary); transform: scaleX(0); transform-origin: left; z-index: 2; transition: transform 0.3s ease; border-radius: 2px 2px 0 0; }
