    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                .category-pill, #comm-container { background: transparent !important; border: none !important; border-radius: 0; padding: 8px 12px; font-size: 13px; gap: 6px; transition: all 0.3s ease; }
                ...
                .category-pill::after, #comm-container::after { content: ""; position: absolute; bottom: -1px; left: 12px; right: 12px; height: 0; transform-origin: bottom; z-index: 2; transition: height 0.3s ease; }
