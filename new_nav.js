    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                .desktop-mega-menu-trending-items a { color: var(--text-inactive); text-decoration: none; font-size: 13px; font-weight: 500; line-height: 1.4; padding: 4px 0; transition: color 0.2s; }
