...
function initNavigationScript() {
    ...
    function resolveActiveParentFromPath(currentPath) {
        const obituariesCommunityOverrides = [
            { path: '/obituaries/yorkton-obituaries', communityKey: 'yorkton' }
        ];
        const obitCommunityOverride = obituariesCommunityOverrides.find(override => isPathMatch(currentPath, override.path));
