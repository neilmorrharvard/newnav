    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                .category-pill::after, #comm-container::after { content: ""; position: absolute; bottom: -1px; left: 0; width: 100%; height: 0; transform-origin: bottom; z-index: 2; transition: height 0.3s ease; }
                .category-pill[data-category="sports"]::after, #comm-container[data-category="communities"]::after { background-color: rgba(34, 197, 94, 0.5); }
                .category-pill[data-category="agriculture"]::after { background-color: rgba(234, 179, 8, 0.5); }
                .category-pill[data-category="obituaries"]::after { background-color: rgba(239, 68, 68, 0.5); }
                ...
                .desktop-down-arrow { display: block !important; }
            }
            ...
            .desktop-mega-menu-inner.communities-menu { gap: 40px; }
            ...
            .desktop-mega-menu-links h3 { font-size: 12px; font-weight: 700; margin: 0 0 12px 0; color: var(--text-inactive); width: 100%; }
            .desktop-mega-menu-links-items { display: flex; flex-direction: column; gap: 12px; width: 100%; }
            .desktop-mega-menu-links-items.multi-column { display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 20px; }
            .desktop-mega-menu-links-items.multi-column.communities-columns { column-gap: 20px; }
            ...
            .desktop-mega-menu-newsletters h3 { font-size: 12px; font-weight: 700; margin: 0 0 12px 0; color: var(--text-inactive); width: 100%; }
            .desktop-mega-menu-newsletters-items { display: flex; flex-direction: column; gap: 12px; width: 100%; }
            .desktop-mega-menu-newsletters-items.multi-column { display: grid; grid-template-columns: repeat(2, 1fr); column-gap: 20px; }
            .desktop-mega-menu-newsletters-items.multi-column.communities-columns { column-gap: 20px; }
