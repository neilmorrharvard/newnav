    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                .category-pill:hover::after, #comm-container:hover::after, .category-pill.hover-active::after, #comm-container.hover-active::after { height: 4px; }
                ...
                .category-pill.hover-active.active::after, #comm-container.hover-active.active::after { height: 4px; background-color: var(--primary); z-index: 3; }
