document.addEventListener('DOMContentLoaded', function() {
    ...
    const downArrow = `<svg class="desktop-down-arrow" style="width:15px; height:15px; flex-shrink:0;" viewBox="0 0 24 24"><path d="M7 10l5 5 5-5z" fill="currentColor"/></svg>`;
    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (min-width: 991px) {
                ...
                .category-pill:hover::after, #comm-container:hover::after, .category-pill.hover-active::after, #comm-container.hover-active::after { height: 3px; }
                .category-pill.active::after, #comm-container.active::after { height: 3px; background-color: var(--primary); z-index: 3; }
                ...
                .category-pill.hover-active.active::after, #comm-container.hover-active.active::after { height: 3px; background-color: var(--primary); z-index: 3; }
                .bottom-row-inner { padding-left: 12px; }
            ...
            .bottom-row { display: none; height: 44px; width: 100%; opacity: 0; position: relative; align-items: center; }
