    ...
    <div id="village-nav-container">
        <style>
            ...
            @media (max-width: 990px) {
                ...
                .category-pill.active .category-icon-wrapper .category-icon svg path { fill: white !important; }
                .category-pill.active .category-icon-wrapper .category-icon svg { filter: brightness(0) invert(1); }
                #comm-container.active .category-icon-wrapper .category-icon svg path { fill: white !important; }
                #comm-container.active .category-icon-wrapper .category-icon svg { filter: brightness(0) invert(1); }
